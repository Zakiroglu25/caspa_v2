...
class MyUser {
  ...
  MyUser.fromJson(Map<String, dynamic> json) {
    ...
    wheel = json['wheel'] ?? false;
    wheel_active = json['wheel_active'] ?? false;
  ...
  Map<String, dynamic> toJson() {
    ...
    data['bonus'] = bonus;
    data['wheel_time'] = wheelTime;
    data['wheel'] = wheel;
    data['wheel_active'] = wheel_active;
