...
class BrachesRegisterField extends StatelessWidget {
  BrachesRegisterField({Key? key, this.selectedWaresId}) : super(key: key);
  int? selectedWaresId;
      ...
      child: BlocBuilder<BranchCubit, BranchesState>(
        builder: (context, state) {
          ...
          if (state is BranchesSuccess) {
            ...
            context.read<RegisterCubit>().updateBranchList(branch);
          }
          return Column(
            children: [
              StreamBuilder(
    ...
    if (branchList != null && branchList.length != 0) {
      Sheet.display(
          ...
          child: StreamBuilder<List<Branch>>(
              stream: BlocProvider.of<RegisterCubit>(context).branchListStream,
