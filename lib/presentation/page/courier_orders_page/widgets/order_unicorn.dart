...
class OrderUnicorn extends StatelessWidget {
  ...
  OrderUnicorn({this.sellerName, this.trackingCode, this.statusId,this.deliveryPrice,this.price});
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                ...
                children: [
                  ProductPropertyV(h: 8,name: "Çatdırılma xidməti", value: deliveryPrice,mainColor: MyColors.green,),

                  CaspaButton(color: MyColors.green,
                  borderRadius: 12,child: Text("hgh"),),
                ],
              ),
            ),
